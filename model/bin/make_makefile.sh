...
#                    settings                                                 #
#                    This script is called by w3_make and thereore does      #
  ...
  do
    case $prog in
     ww3_grid) IDstring='Grid preprocessor'
               core=
               data="w3wdatmd w3gdatmd $glc w3adatmd w3idatmd w3odatmd wmmdatmd"
               prop=
     ...
     ww3_strt) IDstring='Initial conditions program'
               core=
               data="$memcode w3gdatmd $glc w3wdatmd w3adatmd w3idatmd w3odatmd"
               prop=
     ...
     ww3_bound) IDstring='boundary conditions program'
               core=
               data="w3adatmd $memcode w3gdatmd $glc w3wdatmd w3idatmd w3odatmd"
               prop=
     ...
     ww3_prep) IDstring='Field preprocessor'
               core='w3fldsmd'
               data="$memcode w3gdatmd $glc w3adatmd w3idatmd w3odatmd w3wdatmd wmmdatmd"
               prop=
    ...
    ww3_prtide) IDstring='Tide prediction'
               core='w3fldsmd'
               data="wmmdatmd $memcode w3gdatmd $glc w3wdatmd w3adatmd w3idatmd w3odatmd"
               prop="$pr"
             source="$pdlibcode $pdlibyow $db $bt $setupcode w3triamd $stx $nlx $btx $is w3parall $uostmd"
                 IO="w3iogrmd $oasismd $agcmmd $ogcmmd $igcmmd"
   ...
   ww3_sbs1) IDstring='Multi-grid shell sbs version'
               ...
               core="$core w3fldsmd w3initmd w3wavemd w3wdasmd w3updtmd"
               data="w3parall wmmdatmd $memcode w3gdatmd $glc w3wdatmd w3adatmd w3idatmd w3odatmd"
               prop="$pr"
     ...
     ww3_outp) IDstring='Point output'
               core=
               data="wmmdatmd w3parall w3triamd $memcode w3gdatmd $glc w3wdatmd w3adatmd w3idatmd w3odatmd"
               prop=
     ...
     ww3_trck) IDstring='Track output post'
               core=
               data="$memcode w3gdatmd $glc w3odatmd"
               prop=
             source=
                 IO=
     ...
     ww3_grib) IDstring='Gridded output (GRIB)'
               core=
               data="w3parall wmmdatmd w3triamd $memcode w3gdatmd $glc w3wdatmd w3adatmd w3idatmd w3odatmd"
               prop=
     ...
     ww3_gint) IDstring='Grid Interpolation'
      ...
      ww3_systrk) IDstring='Wave system tracking postprocessor'
               core='w3strkmd'
               data="$memcode w3gdatmd $glc w3adatmd w3idatmd w3odatmd w3wdatmd"
               prop=
     ...
     libww3) IDstring='Object file archive'
               core='w3fldsmd w3initmd w3wavemd w3wdasmd w3updtmd'
               data="wmmdatmd w3gdatmd $glc w3wdatmd w3adatmd w3idatmd w3odatmd"
               prop="$pr"
